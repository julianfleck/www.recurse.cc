...
<Accordions type="single" collapsible>
  <Accordion title="1. Add Content">
    ...
    |-------------|----------------|
    | **Upload Content**<br />Select and upload your files<br />Choose content sources<br />Initiate the ingestion process | **Graph Construction**<br />Analyzes and extracts semantic relationships<br />Identifies concepts, arguments, and connections<br />Creates structured knowledge units |

    **Why RAGE excels:** Unlike manual organization or simple file storage, RAGE automatically builds semantic connections between your documents, creating a living knowledge graph that grows smarter over time and surfaces relevant relationships you might never discover manually.
  ...
  <Accordion title="2. Query Information">
    ...
    | What You Do | What RAGE Does |
    |-------------|----------------|
    | **Query submission**<br />Enter search terms or questions<br />Specify search parameters<br />Request contextual information | **Hybrid Vector and Graph Traversal**<br />Navigates the knowledge graph<br />Finds relevant information and relationships<br />Provides comprehensive context |

    **Why RAGE excels:** Traditional search finds keywords; RAGE understands context and relationships. When you ask a question, you get not just relevant documents, but the complete web of connected ideas, arguments, and evidence that provide true understanding.
  ...
  <Accordion title="3. Integrate with AI">
    ...
    | What You Do | What RAGE Does |
    |-------------|----------------|
    | **Use Proxy**<br />Connect to your preferred AI tools<br />Send contextual information<br />Receive enhanced AI responses | **Context Assembly**<br />Structures information for optimal AI consumption<br />Formats data for different AI systems<br />Ensures response quality and accuracy |

    **Why RAGE excels:** Manual context assembly is time-consuming and inconsistent. RAGE automatically structures your knowledge for optimal AI consumption, ensuring every interaction is informed by your complete knowledge base, not just what you can remember to include.
