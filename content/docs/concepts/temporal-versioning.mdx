...
Recurse implements a third approach: knowledge becomes **living memory** (that's what we call **temporal versioning**). The system evolves understanding while preserving the complete evolution history.
...
This is what makes it a **living substrate**—it maintains itself over time.
