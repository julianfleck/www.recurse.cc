...
Start with something meaningful - a research paper, meeting notes, or project documentation

#### Ask Your First Question
Use the web interface or API to query your knowledge
...
<Cards>
  <Card href="./quickstart.mdx" title="Quickstart Guide">
  ...
  <Card href="./guide/Adding%20Content/setup.mdx" title="Adding Content">
    Learn different ways to add your knowledge—from manual uploads to automatic ingestion and browser extensions.
  </Card>
  <Card href="./api-documentation/documents/post.mdx" title="API Reference">
