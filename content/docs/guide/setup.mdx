...
<Cards>
  <Card title="1. Upload Content" icon="folderplus">
    Add documents, articles, or any text content to your knowledge base through the dashboard or API.
  </Card>
  <Card title="2. AI Processing" icon="brain">
    RAGE analyzes and extracts semantic relationships, identifying concepts, arguments, and connections.
  </Card>
  <Card title="3. Graph Building" icon="brain">
    Information forms a connected knowledge network where related concepts are automatically linked.
  </Card>
  <Card title="4. Query & Access" icon="info">
    Search and retrieve contextually relevant information that maintains relationships and context.
  </Card>
</Cards>
