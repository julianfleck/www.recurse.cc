  ...
  return (
    <div className={cn("flex flex-col gap-4", className)}>
      <GlowCard
        ...
        glowIntensity={0.15}
        glowRadius="500px"
        className="rounded-xl border border-border bg-card/50 p-0 shadow-xl"
      >
        {/* Grid: 50/50 split, fixed height */}
        <div className="grid h-[550px] grid-cols-1 overflow-hidden rounded-xl md:grid-cols-2">
          {/* Left: Form */}
          <div className="flex h-full flex-col overflow-y-auto p-6 md:p-8">
            ...
            <div className="flex min-h-0 flex-1 flex-col overflow-y-auto py-4">{children}</div>
