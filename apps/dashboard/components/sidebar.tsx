...
const itemVariants = cva(
  "relative my-[1px] flex flex-row items-center gap-3 rounded-lg p-1.5 ps-(--sidebar-item-offset) text-start text-fd-muted-foreground [overflow-wrap:anywhere] [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      active: {
        true: "border border-muted/40 bg-accent/40 text-accent-foreground",
        false:
          "border border-transparent transition-colors hover:border-muted/40 hover:bg-fd-accent/50 hover:text-fd-accent-foreground/80 hover:transition-none",
      },
    },
  }
);
