...
export function HeaderCard({
		...
		return (
			...
			>
				<GridCard 
					...
					className={cn("group cursor-pointer px-1col py-1col lg:pl-2col lg:pr-1col lg:py-halfcol", className)}
				>
					{content}
				</GridCard>
			</Link>
	...
	return (
		<GridCard 
			enableHoverEffect
			enableSpotlight={enableSpotlight}
			className={cn("group px-1col py-1col lg:pl-2col lg:pr-1col lg:py-halfcol", className)}
		>
			{content}
		</GridCard>
	);
