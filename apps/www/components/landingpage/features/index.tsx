...
function FeatureCard({
	...
	const cardContent = (
		<GridCard enableHoverEffect enableSpotlight className="flex h-full flex-col p-6 md:p-8 group/feature-card relative">
	...
	return (
		<div className="h-full" onMouseEnter={() => setIsCardHovered(true)} onMouseLeave={() => setIsCardHovered(false)}>
			{capability.docLink ? (
