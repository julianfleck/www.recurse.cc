...
export const homepageContent = {
	hero: {
		...
		headlines: [
			"Memory layer that explores connections, not just regurgitates chunks",
			"Memory layer that updates it’s understanding, not just keys and values",
			"Knowledge infrastructure that explores, instead of retrieving similar stuff",
			"Knowledge infrastructure that understands, instead of similarity search",
			"Knowledge graphs that semantically understand, not just entity extraction",
			"Knowledge graphs that support exploration, not just basic fact retrieval",
