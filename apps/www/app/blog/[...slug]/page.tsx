...
export default async function BlogArticlePage(
	...
	// Redirect to Substack URL
	redirect(page.data.substackUrl);

	// ============================================================================
	// COMMENTED OUT: Rendering logic preserved for future styling reference
	// ============================================================================
	// 
	// Access blog post data:
	// - page.data.title - Post title
	// - page.data.description - Post description/summary
	// - page.data.publishedAt - ISO date string
	// - page.data.tags - Array of tag strings
	// - page.data.substackUrl - Original Substack URL
	// - page.data.heroImage - Hero image URL (optional)
	// - page.data.author - Author name (optional, defaults to "Recurse")
	// - page.data.body - MDXContent component for rendering the post body
	//
	// Reusable components available:
	// - ShareDialog from "@/components/blog/ShareDialog" - Share buttons with copy link
	//   Usage: <ShareDialog shareTargets={shareTargets} canonicalUrl={canonicalUrl} title="Share this essay" />
	//
	// Example usage:
