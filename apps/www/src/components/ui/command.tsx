...
function CommandSeparator({
  ...
  return (
    <CommandPrimitive.Separator
      className={cn('-mx-1 h-px bg-border bg-blend-multiply', className)}
...
function CommandItem({
  ...
  return (
    <CommandPrimitive.Item
      className={cn(
        'relative flex cursor-default select-none items-center gap-2 rounded-lg px-2 py-1.5 text-accent-foreground/60 text-sm outline-hidden',
        'data-[selected=true]:bg-primary/40 data-[selected=true]:text-accent-foreground dark:data-[selected=true]:bg-accent/80',
