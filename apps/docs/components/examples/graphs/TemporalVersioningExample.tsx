...
import temporalVersioningDataImport from './temporal-versioning-example.json' with { type: 'json' };
...
const temporalVersioningData: AnimationData = {
  ...
  stepAdditions: temporalVersioningDataImport.stepAdditions as Record<number | string, { nodes: any[]; links: any[] }>,
