...
export const staticPages: SearchItem[] = [
  ...
  },
  {
    ...
    type: "page",
    href: "https://www.recurse.cc/features",
    breadcrumbs: [],
  },
  {
    id: "details",
    ...
    type: "page",
    href: "https://www.recurse.cc/details",
    breadcrumbs: [],
  },
  {
    id: "faq",
  ...
  },
  {
    ...
    type: "page",
    href: "https://www.recurse.cc/technology",
    breadcrumbs: [],
  },
  // Feature Pages
  {
    ...
    summary: "Automatically extract structured semantic frames from unstructured text, preserving meaning and relationships.",
    type: "page",
    href: "https://www.recurse.cc/features/frame-parsing",
    breadcrumbs: ["Features"],
  },
  {
    id: "recursive-memory",
    title: "Recursive Memory",
    summary: "Build knowledge graphs that learn from every interaction, creating self-improving memory systems.",
    type: "page",
    href: "https://www.recurse.cc/features/recursive-memory",
    breadcrumbs: ["Features"],
  },
  {
    id: "operations",
    title: "Context-Aware Operations",
    summary: "Smart operation suggestions that adapt to content type and context, with self-instructing capabilities.",
    type: "page",
    href: "https://www.recurse.cc/features/operations",
    breadcrumbs: ["Features"],
  },
  {
    id: "ingestion",
    title: "Multi-Source Ingestion",
    summary: "Ingest from any source—Slack, email, docs, audio—and transform into structured, queryable knowledge.",
    type: "page",
    href: "https://www.recurse.cc/features/ingestion",
    breadcrumbs: ["Features"],
  },
  // Documentation Pages
  {
